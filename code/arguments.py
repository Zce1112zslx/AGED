...
def parse_args():
    ...
    parser.add_argument(
        "--train_file", type=str, default='../data/train_instance_dic_prompt.npy', help="A csv or a json file containing the training data."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--validation_file", type=str, default='../data/dev_instance_dic_prompt.npy', help="A csv or a json file containing the validation data."
    )
    parser.add_argument(
        "--test_file", type=str, default='../data/test_instance_dic_prompt.npy', help="A csv or a json file containing the Prediction data."
    )
    parser.add_argument(
        "--max_seq_length",
        type=int,
